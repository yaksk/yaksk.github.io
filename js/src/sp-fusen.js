(function(global){
	...
	function Fusen(canvas, ds, _id, text, color, name) {
        ...
        if (fusen_util.getDevice() == "mobile") {
            this.canvas.append('<div id="'+this.id+'" class="p-husen p-husen-resizable theme-husen--'+color+'"><span class="husen-text">'+fusen_util.htmlEscape(text)+'</span><span class="husen-name">'+fusen_util.htmlEscape(name)+'</span></div>');
        } else {
            this.canvas.append('<div id="'+this.id+'" class="p-husen p-husen-resizable theme-husen--'+color+'"><span class="husen-text">'+fusen_util.htmlEscape(text)+'</span><span class="husen-name">'+fusen_util.htmlEscape(name)+'</span><div class="p-husen__cross">×</div></div>');
        }
